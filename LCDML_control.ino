...
// *********************************************************************
  ...
  unsigned long g_LCDML_DISP_press_time = 0;
    // settings
    #define _LCDML_CONTROL_analog_pinx A1
    #define _LCDML_CONTROL_analog_piny A2
    #define _LCDML_CONTROL_digitalread 17 //don't work with u8glib
